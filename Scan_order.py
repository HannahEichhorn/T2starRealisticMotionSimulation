'''
This code was modified from https://github.com/ismrmrd/ismrmrd-python-tools/blob/master/recon_ismrmrd_dataset.py
'''
...
# Load raw data file in ismrmrd format:
filename = "/home/iml/hannah.eichhorn/Data/Raw_data_CVR_validation/Converted_data/2022_07_25" \
           "/raw_ismrmrd_file_FR.h5"
...
for i in range(0, 100):
    print(i, contrast[i], slice[i], y[i])

print('Done')


# calculate from TR and echo times (since Philips does not save an acquisition time stamp):
...
np.savetxt('/home/iml/hannah.eichhorn/Code/Motion_simulation/Scan_order_'+str(nr_slices)+'.txt', save_arr, header='Timing, repetition, contrast, slice, phase encode step y')
...
plt.savefig('/mnt/my_data/Results/Motion_Simulation/Scan_order.png', dpi=300)
plt.show()
...
plt.savefig('/mnt/my_data/Results/Motion_Simulation/Scan_order_zoomed.png', dpi=300)
plt.show()
...
plt.savefig('/mnt/my_data/Results/Motion_Simulation/Scan_order_zoomed_more.png', dpi=300)
plt.show()
